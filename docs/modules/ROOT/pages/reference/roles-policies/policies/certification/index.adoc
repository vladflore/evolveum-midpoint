...
For more details on iterations, see xref:roles-policies/policies/certification/iteration/index.adoc[Certification Campaign Iteration].
...
For a complete list of options for stage definitions and a more detailed explanation, see xref:roles-policies/policies/certification/stages.adoc[Configuring Certification Campaign Stages].

== Quick tutorial

To see how certifications work, see the following xref:roles-policies/policies/certification/tutorial/index.adoc[quick tutorial].
...
This is described in a separate document - xref:roles-policies/policies/certification/stages.adoc[Configuring Certification Campaign Stages].
...
To learn more about actions configuration, see xref:roles-policies/policies/certification/actions.adoc[GUI Actions].
To learn more about columns configuration, see xref:roles-policies/policies/certification/columns-configuration.adoc[Columns configuration].
...
It is hidden in the `End user` initial object by default and can be adapted to meet the specific needs of your project (see xref:admin-gui/admin-gui-config/index.adoc#how-it-works[Admin GUI configuration merging mechanism]).
...
For details, see xref:roles-policies/policies/certification/reports/index.adoc[Access Certification Reports].

== Notifications

The certification module provides notifications for the certification campaign owner, as well as for individual reviewers.
For more information, see xref:roles-policies/policies/certification/notifications.adoc[Access Certification Notifications].

== Security

Individual operations are authorized in a specific way.
For details, see xref:roles-policies/policies/certification/authorization.adoc[Access Certification Security].
