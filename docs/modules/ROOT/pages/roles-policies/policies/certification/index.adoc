...
For more details on iterations, see xref:roles-policies/policies/certification/iteration/index.adoc[].
...
For a complete list of options for stage definitions and a more detailed explanation, see xref:roles-policies/policies/certification/stages/index.adoc[].
...
This is described in a separate document - xref:roles-policies/policies/certification/stages/index.adoc[].
...
To learn more about actions configuration, see xref:roles-policies/policies/certification/actions/index.adoc[GUI Actions].
To learn more about columns configuration, see xref:roles-policies/policies/certification/columns-configuration/index.adoc[Columns configuration].
...
For more information, see xref:roles-policies/policies/certification/notifications/index.adoc[Access Certification Notifications].

== Security

Individual operations are authorized in a specific way.
For details, see xref:roles-policies/policies/certification/authorization/index.adoc[Access Certification Security].
